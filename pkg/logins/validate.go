...
// branch via a blocking modal), otherwise a fixed-branch cashier could
// simply set "branch" in a request body to act on another branch's data.
func (u Users) ResolveBranch(requested string) string {
